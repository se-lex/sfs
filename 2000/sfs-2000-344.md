---
beteckning: 2000:344
rubrik: Lag om Schengens informationssystem
departement: Justitiedepartementet
utfardad_datum: 2000-05-25
ikraft_datum: 2000-12-01
publicerad_datum: 2021-12-09
forarbeten: "Prop. 1999/2000:64, bet. 1999/2000:JuU17, rskr. 1999/2000:215"
pdf_url: https://rkrattsdb.gov.se/SFSdoc/00/000344.pdf
---

# Lag om Schengens informationssystem

## En svensk enhet av Schengens informationssystem

### 1 §

Polismyndigheten ska med hjälp av automatiserad behandling föra ett register som ska vara den svenska nationella enheten i Schengens informationssystem (SIS). Myndigheten ska också behandla tilläggsinformation enligt [12 §](#12).

Registret ska vara anslutet till den centrala enheten i SIS. Polismyndigheten är personuppgiftsansvarig för den behandling av personuppgifter som myndigheten utför enligt denna lag. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).

## Förhållandet till annan reglering

### 1 a §

Denna lag gäller utöver brottsdatalagen ([2018:1177](https://selex.se/eli/sfs/2018/1177)). Lag ([2019:433](https://selex.se/eli/sfs/2019/433)).
...
I SIS II-förordningen finns bestämmelser om att registret även ska innehålla framställningar om att en person ska nekas tillträde till eller uppehållstillstånd i Schengenstaterna. Lag ([2010:380](https://selex.se/eli/sfs/2010/380)).

### 3 a §

Kan en person, om vilken uppgifter har registrerats enligt [3 §](#3), förväxlas med en person vars identitet har missbrukats, ska registreringen kompletteras med uppgifter om den andra personen.

Registrering av kompletterande uppgifter enligt första stycket får ske endast om den som uppgifterna avser har lämnat sitt samtycke. Lag ([2010:380](https://selex.se/eli/sfs/2010/380)).
...
Kompletterande uppgifter enligt [3 a §](#3a) får endast avse sådana uppgifter om personen som anges i första stycket 1–6 samt uppgifter om nummer och datum för personens identitetshandlingar. Lag ([2013:335](https://selex.se/eli/sfs/2013/335)).

## Krav för att en framställning ska få registreras

### 4 a §

En person får bli föremål för registrering endast om uppgifter om efternamn, förnamn, kön, begärd åtgärd och, i förekommande fall, en hänvisning till det beslut som har föranlett registreringen, kan registreras om honom eller henne. Övriga uppgifter enligt [4 §](#4) första stycket ska registreras om de finns tillgängliga. Lag ([2010:380](https://selex.se/eli/sfs/2010/380)).
...
Polismyndigheten får föra in uppgifter i registret endast om behandling av motsvarande slag av uppgifter är tillåten enligt brottsdatalagen ([2018:1177](https://selex.se/eli/sfs/2018/1177)), lagen ([2018:1693](https://selex.se/eli/sfs/2018/1693)) om polisens behandling av personuppgifter inom brottsdatalagens område eller någon annan författning. Lag ([2018:1704](https://selex.se/eli/sfs/2018/1704)).

### 6 §

Polismyndigheten får registrera uppgifter endast om det är nödvändigt för att vidta de åtgärder som anges i [3 §](#3) och endast i ärenden som är av sådan vikt att registreringen framstår som berättigad. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).

## Förbud mot registrering av vissa uppgifter

### 7 §

Polismyndigheten får inte registrera uppgifter i SIS som avslöjar etniskt ursprung, politiska åsikter, religiös eller filosofisk övertygelse, medlemskap i fackförening, eller uppgifter som rör hälsa eller sexualliv. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).

## Sekretess

### 8 §

Att uppgifter i registret kan omfattas av sekretess följer av offentlighets- och sekretesslagen ([2009:400](https://selex.se/eli/sfs/2009/400)). Lag ([2009:486](https://selex.se/eli/sfs/2009/486)).
...
Kompletterande uppgifter enligt [3 a §](#3a) får endast lämnas ut till en myndighet

1. som har rätt att få ut uppgifter om den registrering enligt [3 §](#3) som de kompletterande uppgifterna avser, och

2. som behöver uppgifterna för att undvika en felaktig identifiering.

Regeringen meddelar föreskrifter om att myndigheter som prövar ansökningar om visering och uppehållstillstånd ska ha tillgång till uppgifter som avses i [3 §](#3) andra stycket.

Regeringen meddelar också föreskrifter om att de myndigheter som nämns i första och fjärde styckena får ha direktåtkomst till registret. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).
...
Sådana uppgifter om en person, som har registrerats med stöd av [3 a §](#3a), får endast användas i syfte att skilja personen från en person som har registrerats med stöd av [3 §](#3) eller för att den person vars identitet har missbrukats ska kunna styrka sin identitet.
...
En sökning med hjälp av fingeravtryck för att identifiera en person får göras i samtliga fall. Lag ([2020:1006](https://selex.se/eli/sfs/2020/1006)).
...
1. framställning som rör en person enligt [3 §](#3) första stycket 5, senast ett år efter registreringen,

2. framställning som rör en person i annat fall än som avses i 1, senast tre år efter registreringen,

3. framställning som rör ett föremål enligt [3 §](#3) första stycket 5, senast fem år efter registreringen, och

4. framställning som rör ett föremål enligt [3 §](#3) första stycket 6, senast tio år efter registreringen.
...
Uppgifter som har registrerats med stöd av [3 a §](#3a) ska gallras samtidigt som uppgifterna i den registrering enligt [3 §](#3) som de hänför sig till. Uppgifterna ska gallras tidigare om den person som de avser begär det. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).
...
- när kontroller ska utföras. Lag ([2010:380](https://selex.se/eli/sfs/2010/380)).

### 13 §

Tilläggsinformation får endast användas för att uppnå det syfte för vilket den har överlämnats. Lag ([2010:380](https://selex.se/eli/sfs/2010/380)).

### 14 §

Om tilläggsinformationen utgörs av personuppgifter som har tagits emot från en annan stat, får den bevaras endast under så lång tid som behövs för att uppnå det syfte för vilket den har mottagits. Den får aldrig bevaras längre än ett år efter det att de uppgifter i SIS som den avser har gallrats. Lag ([2014:595](https://selex.se/eli/sfs/2014/595)).

## Skadestånd vid personuppgiftsbehandling som omfattas av brottsdatalagen

### 16 §

Bestämmelsen om skadestånd i 7 kap. [1 §](#kap7.1) brottsdatalagen ([2018:1177](https://selex.se/eli/sfs/2018/1177)) ska tillämpas om behandling av personuppgifter som omfattas av brottsdatalagen skett i strid med denna lag eller föreskrifter som har meddelats i anslutning till den. Lag ([2019:433](https://selex.se/eli/sfs/2019/433)).

## Administrativa sanktionsavgifter vid personuppgiftsbehandling som omfattas av brottsdatalagen

### 17 §

En sanktionsavgift får tas ut av den personuppgiftsansvarige vid överträdelse av bestämmelserna om gallring och bevarande av personuppgifter i 11 och [14 §](#14)§, om överträdelsen skett vid behandling av personuppgifter som omfattas av brottsdatalagen ([2018:1177](https://selex.se/eli/sfs/2018/1177)).

Sanktionsavgiften ska bestämmas till högst 10 000 000 kronor. Lag ([2019:433](https://selex.se/eli/sfs/2019/433)).

## Övergångsbestämmelser

[2010:380](https://selex.se/eli/sfs/2010/380)
