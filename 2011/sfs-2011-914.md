...
# Lag om konsumentskydd vid avtal om tidsdelat boende eller långfristig semesterprodukt
...
En näringsidkare som marknadsför avtal vid ett marknadsförings- eller försäljningsevenemang ska i inbjudan till detta tydligt ange evenemangets natur och dess kommersiella syfte. Information enligt 3–[8 §](#kap2.8)§ ska finnas tillgänglig under hela evenemanget.
...
Utöver vad som följer av [3 §](#kap2.3) ska näringsidkaren i rimlig tid innan ett avtal om tidsdelat boende ingås ge konsumenten utförlig information om
...
3. vilken säkerhet som har ställts enligt 5 kap. [1 §](#kap5.1) och villkoren för den.

### Information innan ett avtal om långfristig semesterprodukt ingås

#### 6 §

Utöver vad som följer av [3 §](#kap2.3) ska näringsidkaren i rimlig tid innan ett avtal om långfristig semesterprodukt ingås ge konsumenten utförlig information om
...
Utöver vad som följer av [3 §](#kap2.3) ska näringsidkaren i rimlig tid innan ett förmedlingsavtal ingås ge konsumenten utförlig information om
...
Utöver vad som följer av [3 §](#kap2.3) ska näringsidkaren i rimlig tid innan ett avtal om bytessystem ingås ge konsumenten utförlig information om
...
Om näringsidkaren inte lämnar information i enlighet med 1–[9 §](#kap2.9)§, ska marknadsföringslagen ([2008:486](https://selex.se/eli/sfs/2008/486)) tillämpas med undantag av bestämmelserna i 29–[36 §](#kap2.36)§ om marknadsstörningsavgift. Sådan information ska anses vara väsentlig enligt [10 §](#kap2.10) tredje stycket den lagen.
...
Konsumenten är inte bunden av ett avtal som har upprättats i strid med första stycket. I ett sådant fall ska 4 kap. 4 och [5 §](#kap3.5)§ tillämpas på motsvarande sätt.
...
Avtalet ska innehålla den information som anges i 2 kap. 3–[8 §](#kap3.8)§. Informationen ska vara klar och begriplig och ges i en sådan blankett som avses i 2 kap. [9 §](#kap2.9) andra stycket.

Konsumenten får mot näringsidkaren åberopa en uppgift eller beskrivning som har lämnats enligt 2 kap. 3–[8 §](#kap3.8)§, även om avtalet avviker från informationen. Detta gäller dock inte om konsumenten i avtalet uttryckligen har godkänt avvikelsen eller om avvikelsen är en följd av omständigheter utanför näringsidkarens kontroll och vars följder denne inte har kunnat undvika.
...
Konsumenten har rätt att frånträda ett avtal som omfattas av denna lag (ångerrätt) genom att sända eller lämna ett skriftligt meddelande om detta till näringsidkaren inom 14 dagar från den dag som anges i [2 §](#kap4.2) (ångerfrist).

I 3 kap. [1 §](#kap3.1) andra stycket finns en bestämmelse om att konsumenten under vissa förutsättningar inte är bunden av ett avtal. Enligt 5 kap. [3 §](#kap5.3) har konsumenten rätt att frånträda ett avtal om långfristig semesterprodukt efter viss betalning.

#### 2 §

Ångerfristen börjar löpa den dag då avtalet ingås eller i förekommande fall den senare dag då konsumenten får en kopia av avtalet. Ångerfristen börjar dock löpa först när kraven i 3 kap. [2 §](#kap3.2), [3 §](#kap4.3) första stycket och [5 §](#kap4.5) uppfylls.

Trots första stycket upphör ångerrätten tre månader och 14 dagar efter den dag då avtalet ingicks eller konsumenten fick en kopia av avtalet, om näringsidkaren inte har uppfyllt kraven i 3 kap. [3 §](#kap3.3) första stycket. Avser underlåtenheten kraven i 3 kap. 2 eller [5 §](#kap4.5), upphör ångerrätten ett år och 14 dagar efter den dagen.
...
Har konsumenten i rätt tid och på ett ändamålsenligt sätt lämnat eller sänt ett meddelande enligt [1 §](#kap4.1) om att han eller hon ångrar avtalet, får meddelandet åberopas även om det försenas, förvanskas eller inte kommer fram.
...
1. om näringsidkaren är skyldig att ställa säkerhet enligt [1 §](#kap5.1), innan säkerheten har ställts,
...
Konsumenten har rätt att frånträda avtalet sedan ett betalningskrav som avser den andra årliga delbetalningen har tagits emot. Lag ([2016:312](https://selex.se/eli/sfs/2016/312)).

### Konsumentens befogenheter vid överlåtelse av fordran

#### 4 §

Bestämmelserna i 28–[30 §](#kap5.30)§ konsumentkreditlagen ([2010:1846](https://selex.se/eli/sfs/2010/1846)) ska tillämpas då näringsidkaren har lämnat konsumenten anstånd med betalningen eller då någon del ska betalas med ett belopp som konsumenten har lånat av näringsidkaren eller någon annan kreditgivare på grund av en överenskommelse mellan denne och näringsidkaren.
...
Om Konsumentverket enligt [2 §](#kap6.2) har förelagt en näringsidkare att tillhandahålla en handling eller upplysning, får beslutet överklagas till allmän förvaltningsdomstol. Andra beslut av Konsumentverket enligt [2 §](#kap6.2) får inte överklagas.
